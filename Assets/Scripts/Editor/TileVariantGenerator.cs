...
public static class TileVariantGenerator
{
    ...
    private static Sprite FlattenSprite(Sprite src, string outName)
    {
        ...
        //
        // ⚠️ DO NOT "FIX" THIS TO THE MEAN. It was changed to the mean on 2026-08-08 on the theory
        // that flattening should be brightness-preserving; it is measurably brighter and the
        // designer rejected it on sight — the interiors read better dark. The low percentile is
        // deliberate, not a bug. Deep rock is metres of stone in shadow.
