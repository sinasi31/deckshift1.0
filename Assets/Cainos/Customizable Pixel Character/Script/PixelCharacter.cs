...
namespace Cainos.CustomizablePixelCharacter
{
    ...
    [HelpURL("https://docs.cainos.net/customizable-pixel-character/script-reference#pixel-character")]
    public class PixelCharacter : MonoBehaviour
    {
        ...
        [FoldoutGroup("Reference")] public Renderer eyeClosed;
        ...
        [FoldoutGroup("Reference")] public Transform rigFootL;
        [FoldoutGroup("Reference")] public Transform rigFootR;
        ...
        public FacingType Facing
        {
            ...
            set
            {
                ...
                weaponSlot.transform.localScale = new Vector3(1.0f, 1.0f, (int)facing);
        ...
        //get all the renderers as a list
        private List<Renderer> Renderers
        {
            get
            {
                if (renderers == null)
                {
                    ...
                    {
                        hat, hair, hairClipped, eye, eyeClosed, eyeBase, facewear, cloth, skirt, pants, socks, shoes, shoesFront, back, expression, body
                    };
                }
                return renderers;
            }
        ...
        public string SortingLayerName
        {
            ...
            set
            {
                ...
                if ( Weapon) Weapon.SortingLayerName = value;
            }
        }
        ...
        public int SortingOrder
        {
            ...
            set
            {
                ...
                if (Weapon) Weapon.SortingOrder = value;
            }
        }
        ...
        {
            get { return isEyeClosed; }
            set
            {
                if ( isEyeClosed == value ) return;
                isEyeClosed = value;

                animator.SetBool("IsEyeClosed", isEyeClosed);
            }
        }
        private bool isEyeClosed;
