...
namespace Cainos.PixelArtMonster_Dungeon
{
    ...
    {
        [FoldoutGroup("Params")] public float speedMax = 2.0f;                                   // max move speed
        [FoldoutGroup("Params")] public float acc = 8.0f;                                        // acceleration
        [FoldoutGroup("Params")] public float brakeAcc = 8.0f;                                   // brake acceleration
        ...
        [FoldoutGroup("Params")] public float deadGravityScale = 1.0f;                           // gravity scale when the character is dead. it actually controls whether should the flying character fall to the ground when it is dead, in most case you should set this to either 0.0 or 1.0
        ...
        public void Move( Vector2 inputMove )
        {
            ...
            if (Mathf.Abs(inputMove.x) > 0.01f) pm.Facing = (PixelMonster.FacingType) Mathf.RoundToInt(inputMove.x);
        }
